							...
							<p>
								<xsl:if test="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader">
									<div style="font-size:8pt; margin-bottom:1px; margin-top:10px; padding:5px; text-align:center; ">
										...
										<table align="center" style="font-size:12pt; width:100%; border-collapse:collapse; margin:0 auto;">
											<tbody>
												<tr>
													...
													<td colspan="4" style="border:solid #000000 1px; padding: 8px; text-align:center; background-color:#f0f0f0; font-weight:bold;">
												...
												<xsl:for-each select="/edefter:defterraporu/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader">
													<xsl:for-each select="gl-cor:entryDetail[gl-cor:xbrlInfo/gl-cor:xbrlInclude='period_change' and gl-cor:debitCreditCode='D']">
														<tr>
															...
															<td style="border:solid #000000 1px; padding: 8px; text-align:center;">
																<b>
